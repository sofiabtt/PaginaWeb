    ...
    <main class="contenido-admin">
        ...
        <section class="encabezado-contenido">
            <div>
                ...
                <p>Reservas que fueron confirmadas.</p>
            </div>
        </section>
                ...
                <tbody>
                    ...
                    <?php while ($compra = $resultado->fetch_assoc()) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                #<?php echo (int) $compra["codReserva"]; ?>
                            </td>

                            <td>
                                <?php echo htmlspecialchars($compra["nombreAerolinea"]); ?>
                            </td>

                            <td>
                                <?php echo htmlspecialchars(
                                    $compra["origenVuelo"] . " - " . $compra["destinoVuelo"]
                                ); ?>
                            </td>
                            ...
                            <td>
                                <?php echo date(
                                    "d/m/Y",
                                    strtotime($compra["fechaSalidaVuelo"])
                                ); ?>
                            </td>

                            <td>
                                $<?php echo number_format(
                                    (float) $compra["precioFinalReserva"],
                                    0,
                                    ",",
                                    "."
                                ); ?>
