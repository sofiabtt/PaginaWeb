...
<body>
    ...
    <main class="contenido-admin">
        ...
        <section class="encabezado-contenido">
            ...
            <div>
                <h1>Buscar vuelos</h1>
                <p>Buscá por origen, destino y fecha.</p>
            </div>
                ...
                <tbody>
                    ...
                    <?php if ($resultado->num_rows === 0) { ?>
                        ...
                        <tr>
                            ...
                            >
                                No encontramos vuelos con esos criterios.
                            </td>
                    ...
                    <?php while ($vuelo = $resultado->fetch_assoc()) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo htmlspecialchars($vuelo["nombreAerolinea"]); ?>
                            </td>

                            <td>
                                <?php echo htmlspecialchars($vuelo["origenVuelo"]); ?>
                            </td>

                            <td>
                                <?php echo htmlspecialchars($vuelo["destinoVuelo"]); ?>
                            </td>
                            ...
                            <td>
                                ...
                                ) . " " . htmlspecialchars($vuelo["horaSalidaVuelo"]); ?>
                            </td>
                            ...
                            <td>
                                <?php echo (int) $vuelo["asientosDisponibles"]; ?>
                            </td>
                            ...
                            <td>
                                ...
                                <a
                                    ...
                                    href="verVuelo.php?id=<?php echo (int) $vuelo["codVuelo"]; ?>"
                                >
                                    Ver detalle
                                </a>
